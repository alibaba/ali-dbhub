...
public class RichTextParam {
     ...
     * @mbg.generated
     */
    public RichTextParam appendOrderByClause(OrderCondition orderCondition, SortType sortType) {
     ...
     * @mbg.generated
     */
    public RichTextParam setPage(boolean page) {
        this.page = page;
        return this;
    }
     ...
     * @mbg.generated
     */
    public RichTextParam setPageSize(int pageSize) {
     ...
     * @mbg.generated
     */
    public RichTextParam setPageStart(int pageStart) {
     ...
     * @mbg.generated
     */
    public RichTextParam appendDistinct(OrderCondition condition) {
        if (null != distinctSql){
