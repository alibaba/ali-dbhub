...
public class ChatGptSystemConfigRequest {
    ...
    /** OpenAi APIKEY 使用OpenAi接口时必填，可前往OpenAI官网查看APIKEY */
    private String apiKey;

    /** OpenAi APIHOST 非必填，默认值为 https://api.openai.com/ */
    private String apiHost;

    /** http代理Host 非必填，用于设置请求OPENAI接口时的HTTP代理host */
    private String httpProxyHost;

    /** http代理Port 非必填，用于设置请求OPENAI接口时的HTTP代理port */
    ...
    /** 自定义AI接口 选择自定义AI时必填，用于设置自定义AI的REST接口URL */
