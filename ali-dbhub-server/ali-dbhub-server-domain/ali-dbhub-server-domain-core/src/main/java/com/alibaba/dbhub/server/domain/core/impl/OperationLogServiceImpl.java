...
public class OperationLogServiceImpl implements OperationLogService {
    ...
    @Autowired private OperationLogConverter operationLogConverter;
    ...
    public PageResult<OperationLog> queryPage(OperationLogPageQueryParam param) {
        ...
        IPage<OperationLogDO> executedDdlDOIPage =
                operationLogMapper.selectPage(page, queryWrapper);
        List<OperationLog> executedDdlDTOS =
                operationLogConverter.do2dto(executedDdlDOIPage.getRecords());
        ...
        List<Long> dataSourceIds =
                executedDdlDTOS.stream().map(OperationLog::getDataSourceId).toList();
