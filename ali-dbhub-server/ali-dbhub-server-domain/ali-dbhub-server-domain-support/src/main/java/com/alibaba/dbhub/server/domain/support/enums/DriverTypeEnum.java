...
public enum DriverTypeEnum {
    /** MySQL */
    MYSQL_DRIVER(
            DbTypeEnum.MYSQL, "com.mysql.cj.jdbc.Driver", "mysql-connector-java-8.0.30.jar", "8.0"),

    /** MySQL 5.1版本 */
    MYSQL_DRIVER_5_1(
            DbTypeEnum.MYSQL, "com.mysql.jdbc.Driver", "mysql-connector-java-5.1.47.jar", "5.0"),
    ...
    ORACLE_DRIVER(
            ...
            "ojdbc8-19.3.0.0.jar,orai18n-19.3.0.0.jar",
            ""),
    ...
    /** OceanBase */
    OCEANBASE_DRIVER(
            DbTypeEnum.OCEANBASE, "com.oceanbase.jdbc.Driver", "oceanbase-client-2.4.2.jar", ""),
    ...
    /** MMARIADB */
    MARIADB_DRIVER(
            DbTypeEnum.MARIADB, "org.mariadb.jdbc.Driver", "mariadb-java-client-3.0.8.jar", ""),
    ...
    /** KINGBASE_DRIVER com.kingbase8.Driver */
    ...
    /** MONGODB_DRIVER com.dbschema.MongoJdbcDriver */
    MONGODB_DRIVER(
            DbTypeEnum.MONGODB,
            "com.dbschema.MongoJdbcDriver",
            "mongo-jdbc-standalone-1.18.jar",
            "");
