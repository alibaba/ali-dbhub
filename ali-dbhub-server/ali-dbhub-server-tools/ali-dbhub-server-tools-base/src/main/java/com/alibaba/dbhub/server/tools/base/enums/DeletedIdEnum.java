package com.alibaba.dbhub.server.tools.base.enums;
 ...
 * 删除标记枚举
 *
 * <p>为了兼容唯一主键+逻辑删除。使用DeletedId来标记当前数据是否删除。如果是0 则代表未删除。其他任何情况都代表已经删除。 删除的时候 执行语句：update set
 * deleted_id = di where 条件=条件；
 *
 * @author 是仪
 */
@Getter
