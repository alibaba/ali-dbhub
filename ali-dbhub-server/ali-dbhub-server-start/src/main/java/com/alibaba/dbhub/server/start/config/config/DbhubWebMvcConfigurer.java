...
public class DbhubWebMvcConfigurer implements WebMvcConfigurer {
    ...
    /** 全局放行的url */
    private static final String[] FRONT_PERMIT_ALL =
            new String[] {"/favicon.ico", "/error", "/static/**", "/api/system"};
