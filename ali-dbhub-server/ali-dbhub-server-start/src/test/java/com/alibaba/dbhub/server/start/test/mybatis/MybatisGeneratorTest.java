package com.alibaba.dbhub.server.start.test.mybatis;
...
import com.alibaba.dbhub.server.start.test.common.BaseTest;
...
public class MybatisGeneratorTest extends BaseTest {
    ...
    public void coreGenerator() {
        ...
        doGenerator(Lists.newArrayList("environment","data_source","team","team_permission","dbhub_user_team","data_source_access"));
    }
